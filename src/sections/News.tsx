  ...
  const news = [
    {
      id: 1,
      type: 'event',
      title: 'Forum Afrique MKH',
      date: '2026',
      location: 'Afrique',
      description: 'Grand forum panafricain réunissant les leaders économiques, politiques et culturels du continent. Une plateforme d\'échanges et de partenariats pour accélérer le développement africain.',
      image: '/images site MKH new/Forum Afrique.jpg',
    },
    {
      id: 2,
      type: 'event',
    ...
    },
    {
      id: 3,
      type: 'event',
      title: 'Gala de Charité MKH — Paris',
      date: '15 Juin 2027',
      location: 'Paris, France',
      description: 'Soirée de levée de fonds pour le financement des programmes de lutte contre la pauvreté au Cameroun.',
      image: '/images site MKH new/4.jpg',
    },
    {
      id: 4,
      type: 'action',
